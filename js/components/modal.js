export const addStudentModal = () => {
    ...
    <div class="border absolute w-[100%] h-full top-0 left-0 flex justify-center items-center  bg-black/85  hidden" id ="modal">
            ...
            <form action="" class="grid grid-cols-2 gap-7" id="modal_form">
      <div class="col-span-2 flex justify-between items-center">
               ...
               <button class=" justify-self-end cursor-pointer" id="close_modal" type="button"> <img src="./assets/images/icons/close-lg-svgrepo-com.svg" alt="close button" class=" h-5"  ></button>
                ...
                <div class="flex flex-col">
                        ...
                        <input type="text" name= "fullname" placeholder="Enter student fullname" class="outline-0 border border-gray-400 p-1 rounded-sm focus:border-amber-500" id="input_fullname">
                </div>  
                 <div class="flex flex-col">
                        <label for="input_email">Email</label>
                        <input type="email" name= "email" placeholder="Enter student email" class="outline-0 border border-gray-400 p-1 rounded-sm focus:border-amber-500" id="input_email">
                </div>  
                <div class="flex flex-col">
                ...
                <div class="flex flex-col" >
                        <label for="input_gpa">GPA</label>
                        <input type="text" name="gpa"  placeholder="Enter student GPA" class="outline-0 border border-gray-400 p-1 rounded-sm focus:border-amber-500" id="input_gpa">
                </div>  
                <div class="flex flex-col">
                ...
                <button type="submit" class="col-span-2 bg-blue-500  rounded-md text-white cursor-pointer p-1 disabled:bg-blue-300"  id="submit_student"  >Add Student</button>
            </form>
             </div>
        </div>`
}